  ...
  return (
    <div>
      ...
      >
        ...
        <div class='flex flex-col justify-items-center items-center md:p-10 md:w-8/12'>
          <h2 class='font-content_header md:text-6xl md:pb-10 text-center'>
            Create a full-stack web application using AWS Amplify
          </h2>
          <p class='font-serif md:text-2xl'>Updated At: Fri,15/1/2021</p>
          <Photo
            src={amplify}
          ...
          />
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <p class='font-content md:leading-loose md:text-xl font-bold italic py-4 md:py-7'>
          ...
          <div class='flex flex-col justify-items-start md:py-16'>
            <h3 class='font-serif md:text-2xl'>Content</h3>
            <ul class='md:text-xl list-disc list-inside'>
              <li>
                {' '}
                <Link smooth to='/post/create-amplify-app/#archi' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  ARCHITECTURE
                </Link>
              </li>
              <li>
                <Link smooth to='/post/create-amplify-app/#workflow' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  WORKFLOW USING AMPLIFY
                </Link>
              </li>
              <li>
                <Link smooth to='/post/create-amplify-app/#visitor' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  IMPLEMENT A VISITOR DASHBOARD
                </Link>
              </li>
              <li>
                <Link smooth to='/post/create-amplify-app/#cv' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  PROCESS MY CV DYNAMICALLY
                </Link>
              </li>
              <li>
                <Link smooth to='/post/create-amplify-app/#email' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  IMPLEMENT EMAIL NOTIFICATION FOR CONTACT
                </Link>
              </li>
              <li>
                <Link smooth to='/post/create-amplify-app/#token' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  “MISSING AUTHENTICATION TOKEN” — APIGATEWAY TROUBLESHOOTING
                </Link>
              </li>
              <li>
                <Link smooth to='/post/create-amplify-app/#apiKey' class='text-black font-subtitle text-base md:text-2xl transition duration-500 ease-in-out hover:bg-green2 hover:text-white'>
                  ROTATE API KEY FOR APPSYNC API
                </Link>
              </li>
            </ul>
          </div>
          <h2 id='archi' class='font-content_header md:text-3xl place-self-start md:py-10'>ARCHITECTURE</h2>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <h2 id='workflow' class='font-content_header md:text-3xl place-self-start md:py-10'>WORKFLOW USING AMPLIFY</h2>
          <Photo
            src={workflow}
          ...
          <h2 id='visitor' class='font-content_header md:text-3xl place-self-start md:py-10'>IMPLEMENT A VISITOR DASHBOARD</h2>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <pre class='text-green2 md:text-xl'>
          ...
          <pre class='text-green2 md:text-xl'>input UpdateVisitorCountInput {'{id: ID!  count: Int}'}</pre>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <h2 id='cv' class='font-content_header md:text-3xl place-self-start md:py-10'>PROCESS MY CV DYNAMICALLY</h2>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <h2 id='email' class='font-content_header md:text-3xl place-self-start md:py-10'>IMPLEMENT EMAIL NOTIFICATION FOR CONTACT</h2>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <h2 id='token' class='font-content_header md:text-3xl place-self-start md:py-10'>
            “MISSING AUTHENTICATION TOKEN” — APIGATEWAY TROUBLESHOOTING
          </h2>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
          ...
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7 text-left'>
          ...
          <h2 id='apiKey' class='font-content_header md:text-3xl place-self-start md:py-10'>ROTATE API KEY FOR APPSYNC API</h2>
          <p class='font-content md:leading-loose md:text-xl py-4 md:py-7'>
